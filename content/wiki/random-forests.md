...
hideReply = true
tags = ['machine learning', 'ML', 'machine_learning', 'programming', 'statistics', 'information gain', 'gini index', 'entropy', 'cart', 'classification', 'regression', 'bagging', 'boostrapping', 'aggregation']
+++
...
1. **Ensamle Learning**: Combining the decisions from multiple models to improve overall performance
